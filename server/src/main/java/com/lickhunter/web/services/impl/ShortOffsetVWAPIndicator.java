...
public class ShortOffsetVWAPIndicator extends VWAPIndicator {
     ...
     */
    public ShortOffsetVWAPIndicator(BarSeries series, int barCount, double offset) {
    ...
    protected Num calculate(int index) {
        ...
        return vwap.plus(vwap.multipliedBy(offset.dividedBy(numOf(100))));
    }
}
